...
<div class="row">
	<div class="large-5 columns large-centered text-center medium-6 medium-centered last">
		<h4 class="show-for-small"><a href="<?php echo $site_url.'accountHistory.php?type='.$_GET["type"];?>" class="button tiny left">Back</a>Your Trends<a href="/logout.php" class="button secondary tiny right">Logout</a></h4>
		<h3 class="hide-for-small"><a href="<?php echo $site_url.'accountHistory.php?type='.$_GET["type"];?>" class="button tiny left">Back</a>Your Trends<a href="/logout.php" class="button secondary tiny right">Logout</a></h3>
		<hr>
		
		<h3><?php echo $page_type." per Location in the last 30 days"?></h3>
